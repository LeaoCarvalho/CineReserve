...
from .views import LockSeatView, SessionSeatsView, TakeSeatView, UserTicketsView, session_seats_page
...
urlpatterns = [
    ...
    path("me/tickets/", UserTicketsView.as_view(), name="user-tickets"),
    path("sessions/<int:session_id>/view/", session_seats_page),
]